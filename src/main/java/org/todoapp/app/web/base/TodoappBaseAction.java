 ...
 */
package org.todoapp.app.web.base;
...
import org.todoapp.app.logic.context.AccessContextLogic;
import org.todoapp.app.web.base.login.TodoappLoginAssist;
import org.todoapp.app.web.base.view.HeaderBean;
 ...
 * @author jflute
 */
public abstract class TodoappBaseAction extends TypicalAction // has several interfaces for direct use
        implements LaValidatable<TodoappMessages>, TodoappHtmlPath {

    // ===================================================================================
    //                                                                          Definition
    //                                                                          ==========
    /** The application type for HarBoR, e.g. used by access context. */
    protected static final String APP_TYPE = "TDA"; // #change_it_first
    ...
    @Override
    protected OptionalThing<TodoappUserBean> getUserBean() { // application may call, overriding for co-variant
    ...
    @Override
    public ActionValidator<TodoappMessages> createValidator() { // for co-variant
        return super.createValidator();
    }

    @Override
    public TodoappMessages createMessages() { // application may call
        return new TodoappMessages(); // overriding to change return type to concrete-class
    }
