...
import org.todoapp.mylasta.direction.TodoappEnv;
import org.lastaflute.core.direction.exception.ConfigPropertyNotFoundException;

/**
 * @author FreeGen
 */
public interface TodoappConfig extends TodoappEnv {

    /** The key of the configuration. e.g. todoapp */
     ...
     * @return The value of found property. (NotNull: if not found, exception but basically no way)
     */
    String getCookieRememberMeTodoappKey();

    /**
     * The simple implementation for configuration.
     * @author FreeGen
     */
    public static class SimpleImpl extends TodoappEnv.SimpleImpl implements TodoappConfig {

        /** The serial version UID for object serialization. (Default) */
        private static final long serialVersionUID = 1L;

        public String getDomainName() {
            return get(TodoappConfig.DOMAIN_NAME);
        }

        public String getDomainTitle() {
            return get(TodoappConfig.DOMAIN_TITLE);
        }

        public String getAppStandardDatePattern() {
            return get(TodoappConfig.APP_STANDARD_DATE_PATTERN);
        }

        public String getAppStandardDatetimePattern() {
            return get(TodoappConfig.APP_STANDARD_DATETIME_PATTERN);
        }

        public String getAppStandardTimePattern() {
            return get(TodoappConfig.APP_STANDARD_TIME_PATTERN);
        }

        public String getCookieDefaultPath() {
            return get(TodoappConfig.COOKIE_DEFAULT_PATH);
        }

        public String getCookieDefaultExpire() {
            return get(TodoappConfig.COOKIE_DEFAULT_EXPIRE);
        }

        public Integer getCookieDefaultExpireAsInteger() {
            return getAsInteger(TodoappConfig.COOKIE_DEFAULT_EXPIRE);
        }

        public String getCookieEternalExpire() {
            return get(TodoappConfig.COOKIE_ETERNAL_EXPIRE);
        }

        public Integer getCookieEternalExpireAsInteger() {
            return getAsInteger(TodoappConfig.COOKIE_ETERNAL_EXPIRE);
        }
