...
import org.todoapp.mylasta.direction.sponsor.TodoappApiFailureHook.UnifiedFailureResult.FailureErrorPart;
 ...
 * @author jflute
 */
public class TodoappApiFailureHook implements ApiFailureHook { // #change_it for handling API failure
