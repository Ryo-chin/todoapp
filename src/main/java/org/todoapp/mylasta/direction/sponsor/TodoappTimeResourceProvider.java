 ...
 * @author jflute
 */
public class TodoappTimeResourceProvider extends TypicalTimeResourceProvider {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected final TodoappConfig config;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public TodoappTimeResourceProvider(TodoappConfig config) {
        this.config = config;
    }
    ...
    protected TimeZone getCentralTimeZone() {
        return TodoappUserTimeZoneProcessProvider.centralTimeZone;
    }
