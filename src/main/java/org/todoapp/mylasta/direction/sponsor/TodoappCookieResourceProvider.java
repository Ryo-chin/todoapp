 ...
 * @author jflute
 */
public class TodoappCookieResourceProvider implements CookieResourceProvider {

    protected final TodoappConfig config;
    protected final InvertibleCryptographer cookieCipher;

    public TodoappCookieResourceProvider(TodoappConfig config, InvertibleCryptographer cookieCipher) {
        this.config = config;
