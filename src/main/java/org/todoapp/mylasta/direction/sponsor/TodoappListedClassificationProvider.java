...
import org.todoapp.dbflute.allcommon.DBCurrent;
import org.todoapp.mylasta.appcls.AppCDef;
 ...
 * @author jflute
 */
public class TodoappListedClassificationProvider extends TypicalListedClassificationProvider { // basically for HTML response
