...
public class MemberDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnMemberId = cci("MEMBER_ID", "MEMBER_ID", null, "会員ID", Integer.class, "memberId", null, true, true, true, "INT", 10, 0, null, false, null, null, null, "memberAddressList,memberFollowingByMyMemberIdList,memberFollowingByYourMemberIdList,memberLoginList,purchaseList", null, false);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.todoapp.dbflute.exentity.Member"; }
    public String getConditionBeanTypeName() { return "org.todoapp.dbflute.cbean.MemberCB"; }
    public String getBehaviorTypeName() { return "org.todoapp.dbflute.exbhv.MemberBhv"; }
