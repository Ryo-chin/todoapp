...
public class ProductDbm extends AbstractDBMeta {
    ...
    protected final ColumnInfo _columnProductStatusCode = cci("PRODUCT_STATUS_CODE", "PRODUCT_STATUS_CODE", null, "商品ステータスコード", String.class, "productStatusCode", null, false, false, true, "CHAR", 3, 0, null, false, null, null, "productStatus", null, null, false);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.todoapp.dbflute.exentity.Product"; }
    public String getConditionBeanTypeName() { return "org.todoapp.dbflute.cbean.ProductCB"; }
    public String getBehaviorTypeName() { return "org.todoapp.dbflute.exbhv.ProductBhv"; }
