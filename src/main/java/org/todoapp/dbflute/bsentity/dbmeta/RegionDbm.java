...
public class RegionDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnRegionId = cci("REGION_ID", "REGION_ID", null, "地域ID", Integer.class, "regionId", null, true, false, true, "INT", 10, 0, null, false, null, null, null, "memberAddressList", null, false);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.todoapp.dbflute.exentity.Region"; }
    public String getConditionBeanTypeName() { return "org.todoapp.dbflute.cbean.RegionCB"; }
    public String getBehaviorTypeName() { return "org.todoapp.dbflute.exbhv.RegionBhv"; }
